      ...
      <div className="  sm:flex md:flex lg:flex xl:flex justify-center items-center ">
        ...
        <div className="xl:flex xl:justify-center items-center  xl:space-x-28 space-y-10   py-10 ">
          <div className=" flex justify-center xl:mt-32  " >
            <img src='./images/figur.jpg' className="group w-2/4 sm:w-1/2 lg:w-1/3  xl:w-[60%]  xl:ml-52 xl:mt-[-50px] hover:scale-110 hover:z-30 rounded-lg" style={{ boxShadow: 'rgba(0, 0, 0, 0.5) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px', transition: "all ease-in-out .3s" }} id="main-img" alt="" />
          </div>
