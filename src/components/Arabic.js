...
const Arabic = () => {
    return (
        <div className='absolute top-[12%] grid grid-cols-2 gap-10 mx-32 px-10 py-10  rounded-md'>
            <div className='text-white flex justify-center items-center mx-5 mt-3 '>
                <div className=''>
                    <h1 className='text-5xl font-bold pb-5'>Get a Arabic Mehndi Quotation</h1>
            ...
            <div className=' flex  h-[500px] bg-white drop-shadow-xl rounded-md py-5  px-10 '>
