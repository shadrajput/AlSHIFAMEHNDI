            ...
            <div className="card3 w-3/4 sm:w-2/5 md:w-2/5 lg:w-[30%] xl:w-1/5 pt-10">
              <NavLink to="/Bridal">
                <div className="card-content space-y-3 ">
                  ...
                  <p className="card-body text-white text-sm ">
                    Mehndi is temporary body art of skin. It is most popular in This bridal mehndi design takes symmetry to the next level. A paisley design has been drawn in circular shape which is then surrounded by leaves and petals. And when both the hands are bought together the two halves become one complete motif.
                  </p>
                  <Link className='Link' to="Contact" spy={true} smooth={true} offset={-50} duration={500} >
                    <span className="relative inline-flex items-center cursor-pointer justify-center px-5 py-1 overflow-hidden  font-mono font-medium tracking-tighter hover:text-white text-[#571217] bg-[#fff] rounded-lg group my-3">
                      <span className="absolute w-0 h-0 transition-all duration-500 ease-out  bg-[#571217] rounded-full group-hover:w-56 group-hover:h-56"></span>
            ...
            <div className="card4 w-3/4 sm:w-2/5 md:w-2/5 lg:w-[30%] xl:w-1/5 pt-10">
              <NavLink to="/Figur">
                <div className="card-content space-y-3 ">
                  ...
                  <p className="card-body text-white text-sm ">
                  Figure Mehndi is trending mehendi designs for brides. So, brides prefer to have figure of lord Krishna, Shiva, Rama, Yamunaji or favourite symbols, favourite hero or favorite persons. Though Figure Mehndi is trending but it really requires proper knowledge and skillsets.Figure Mehndi is trending mehendi designs for brides.
                  </p>
                  <Link className='Link' to="Contact" spy={true} smooth={true} offset={-50} duration={500} >
                    <span className="relative inline-flex items-center cursor-pointer justify-center px-5 py-1 overflow-hidden  font-mono font-medium tracking-tighter hover:text-white text-[#571217] bg-[#fff] rounded-lg group my-3">
                      <span className="absolute w-0 h-0 transition-all duration-500 ease-out  bg-[#571217] rounded-full group-hover:w-56 group-hover:h-56"></span>
