                    ...
                    <div className="xl:absolute w-full h-full top-0 left-0  ">
                        ...
                        <div className='items-center justify-center absolute top-[10%] sm:top-[20%] md:top-[22%] lg:top-[25%] xl:top-[20%] mx-5 sm:mx-10 grid xl:grid-cols-2 sm:grid-cols-2 gap-10 xl:mx-32 xl:px-10 xl:py-10  rounded-md'>
                            <div className='text-white flex justify-center items-center xl:mx-5 mt-3 '>
                                <div className=''>
                                    <h1 className='text-3xl sm:text-2xl md:text-3xl text-center lg:text-left xl:text-5xl font-bold pb-5'>Moghlai Mehndi Quotation</h1>
                                    <h1 className=' text-center lg:text-left text-sm sm:text-xs xl:text-sm text-gray-300'>
                                    When one thinks of the word ‘Mughlai’, probably some of the first things that usually comes to everyone’s mind are the Mughal dynasty, the Mughal emperors, the Mughal architecture or the Mughlai cuisine. But, there is also another thing that the Mughals have passed over the centuries – the regal Mughlai Mehndi designs – that have been embraced by millions of women in countless traditional and auspicious occasions.</h1>
                                ...
                                <div className=' w-full'>
                                    ...
                                    <div className='py-3 xl:py-8 space-y-5 sm:space-y-2 xl:space-y-5'>
                                        ...
                                        <div className='flex justify-between items-center'>
                                            ...
                                            <h1 className='text-lg xl:text-xl text-[#571217]'>200/-</h1>
                                        </div>
