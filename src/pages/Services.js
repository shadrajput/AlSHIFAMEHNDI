      ...
      <section className='' id='Services'>
        <div className='lg:mx-14 xl:mx-20 md:mx-20 sm:mx-0 mx-10  services xl:h-full py-5 xl:py-5 ' >
          ...
          <div className='flex-wrap  md:justify-between md:space-y-0 md:space-x-0 md:gap-14 gap-5 sm:space-x-0 sm:space-y-0 flex justify-center xl:justify-between items-center py-10 space-y-5  lg:space-y-0 lg:space-x-0 xl:space-y-0 '>
            ...
            {/* <div className="card relative xl:w-64 rounded-lg  hover:cursor-pointer xl:space-y-0 space-y-4">
              <div className='xl:h-full xl:w-full flex justify-center'>
                <img src="/images/bridal.jpg" alt="" className='xl:h-full rounded-lg xl:w-full w-3/4 md:w-1/2 '
                  style={{ boxShadow: 'rgba(0, 0, 0, 0.5) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px' }}
                />

              </div>
              <div className=''>
                <h1 className='text-xl md:text-3xl lg:text-5xl xl:text-xl py-3 text-center uppercase font-semibold text-black'>Arabic Mehndi</h1>
                <p className='text-center text-sm md:text-xl lg:text-3xl xl:text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda ab numquam nemo inventore exercitationem reprehenderit odio illo laudantium iusto a consectetur facere vitae totam pariatur, nostrum, sunt explicabo eligendi quaerat!</p>
                <div className='flex justify-center items-center py-5'>
                  <span className="relative inline-flex items-center justify-center px-8 py-2 md:px-10 md:py-3 lg:px-14 lg:py-4 lg:text-2xl md:text-lg xl:text-base xl:px-8 xl:py-2 overflow-hidden font-mono font-medium tracking-tighter hover:text-[#571217] text-white bg-[#571217]  rounded-full group">
                    <span className="absolute w-0 h-0 transition-all duration-500 ease-out  bg-[#e9dac7] rounded-full group-hover:w-56 group-hover:h-56"></span>
            ...
            {/* <div className="card relative xl:w-64 rounded-lg  hover:cursor-pointer ">
              <div className='xl:h-full xl:w-full flex justify-center'>
                <img src="/images/figur.jpg" alt="" className='xl:h-full rounded-lg xl:w-full w-3/4 ' />

              </div>
              <div className=''>
                <h1 className='text-xl py-3 text-center uppercase font-semibold text-black'>Bridal Mehndi</h1>
                <p className='text-center text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda ab numquam nemo inventore exercitationem reprehenderit odio illo laudantium iusto a consectetur facere vitae totam pariatur, nostrum, sunt explicabo eligendi quaerat!</p>
                <div className='flex justify-center items-center py-5'>
                  <span className="relative inline-flex items-center justify-center px-8 py-2 overflow-hidden font-mono font-medium tracking-tighter hover:text-[#571217] text-white bg-[#571217]  rounded-full group">
                    <span className="absolute w-0 h-0 transition-all duration-500 ease-out  bg-[#e9dac7] rounded-full group-hover:w-56 group-hover:h-56"></span>
                    <span className="relative">Know More</span>
                  </span>
                </div>
            ...
            <div className="card relative xl:w-64 rounded-lg  hover:cursor-pointer ">
              <div className='xl:h-full xl:w-full flex justify-center'>
                <img src="/images/cvl.jpg" alt="" className='xl:h-full rounded-lg xl:w-full w-3/4 ' />

              </div>            <div className=''>
                <h1 className='text-xl py-3 text-center uppercase font-semibold text-black'>Moghlai Mehndi</h1>
                <p className='text-center text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda ab numquam nemo inventore exercitationem reprehenderit odio illo laudantium iusto a consectetur facere vitae totam pariatur, nostrum, sunt explicabo eligendi quaerat!</p>
                <div className='flex justify-center items-center py-5'>
                  <span className="relative inline-flex items-center justify-center px-8 py-2 overflow-hidden font-mono font-medium tracking-tighter hover:text-[#571217] text-white bg-[#571217]  rounded-full group">
                    <span className="absolute w-0 h-0 transition-all duration-500 ease-out  bg-[#e9dac7] rounded-full group-hover:w-56 group-hover:h-56"></span>
            ...
            <div className="card relative xl:w-64 rounded-lg  hover:cursor-pointer ">
              <div className='xl:h-full xl:w-full flex justify-center'>
                <img src="/images/servicea.jpg" alt="" className='xl:h-full rounded-lg xl:w-full w-3/4 ' />

              </div>
              <div className=''>
                <h1 className='text-xl py-3 text-center uppercase font-semibold text-black'>figure Mehndi</h1>
                <p className='text-center text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda ab numquam nemo inventore exercitationem reprehenderit odio illo laudantium iusto a consectetur facere vitae totam pariatur, nostrum, sunt explicabo eligendi quaerat!</p>
                <div className='flex justify-center items-center py-5'>
                  <span className="relative inline-flex items-center justify-center px-8 py-2 overflow-hidden font-mono font-medium tracking-tighter hover:text-[#571217] text-white bg-[#571217]  rounded-full group">
                    <span className="absolute w-0 h-0 transition-all duration-500 ease-out  bg-[#e9dac7] rounded-full group-hover:w-56 group-hover:h-56"></span>
